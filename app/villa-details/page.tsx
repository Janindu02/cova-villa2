    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          <h1 className="text-5xl md:text-6xl font-serif text-white mb-4">Villa Details</h1>
          <p className="text-xl text-white/90">Discover the luxury and comfort of Cova Villa</p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-serif text-[#2c1810] mb-6">The Essence of Cova Villa</h2>
          <p className="text-lg text-[#2c1810]/80 leading-relaxed mb-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-serif text-[#2c1810] text-center mb-12">Villa Highlights</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-serif text-[#2c1810] text-center mb-12">Our Exquisite Rooms</h2>
